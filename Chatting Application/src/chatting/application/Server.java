...
public class Server implements ActionListener {
    ...
    Server(){
        ...
        Image i11 = i10.getImage().getScaledInstance(35, 32, Image.SCALE_DEFAULT);
        ImageIcon i12 = new ImageIcon(i11);
        JLabel phone = new JLabel(i12);
        phone.setBounds(350, 20, 35, 32);
        p1.add(phone);
        ...
        a1 = new JPanel();
        a1.setBounds(5, 75, 442, 445);
        f.add(a1);
        
        text = new JTextField();
        text.setBounds(5, 525, 315, 25);
        text.setFont(new Font("SAN_SERIF", Font.PLAIN, 16));
        f.add(text);
        
        JButton send = new JButton("send");
        send.setBounds(320, 525, 123, 23);
